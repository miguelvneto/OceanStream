document.addEventListener('DOMContentLoaded', () => {
    ...
    var markers = [
        ...
        { 
            ...
            url: '../EstacaoMeteorologica/index.html'
        },
        { 
        ...
        { 
            ...
            url: '../Ondografo-Pier_II/index.html'
        },
        { 
    ...
    markers.forEach(markerData => {
        ...
        marker.bindPopup(markerData.info);
         ...
         marker.on('click', function (e) {
                    window.location.href = markerData.url; // Redirecionar ao clicar no marcador
                });
