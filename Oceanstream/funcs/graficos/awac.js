...
// async function reqAPI(tk, nome_tabela, startDate, endDate) {
//     const url = 'http://localhost:1848/dados';
...
//         localStorage.setItem('currentGraph', JSON.stringify(data));
...
async function reqAPI(nome_tabela) {
    ...
    try {
        ...
        // const response1 = await fetch('http://localhost:1848/login', {
        //     method: 'POST',
        //     headers: {
        //        'Content-Type': 'application/json'
        //     },
        //     body: JSON.stringify({
        //         email: 'giuliano.demoner@gmail.com',
        //         senha: 'senha123'
        //     })
        // });
        ...
        const response = await fetch('http://localhost:1848/dados', {
            method: 'POST',
            headers: head,
            body: corpo
        });
